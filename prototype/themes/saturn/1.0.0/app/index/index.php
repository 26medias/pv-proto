	...
	setMetas(array(
        ...
        while ($i <= 20) {
           ...
           //Checks to see if the post is a post by the page and not another user. Also make sure there is at least a message, picture, or source.
            if ($pageData['posts']['data'][$i]['story'] == "" && ($pageData['posts']['data'][$i]['picture'] != "" or $pageData['posts']['data'][$i]['source'] != "" or $pageData['posts']['data'][$i]['message'] != "" )) {
	    ...
	    else if (preg_match('#\b(video.ak.fbcdn)\b#', $postSource)){
