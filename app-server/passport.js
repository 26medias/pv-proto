		...
		switch (type) {
			case	"facebook":
				passport.use(new FacebookStrategy({
					...
					// Set the avatar
					profile.avatar	= {
						small:	"http://graph.facebook.com/"+profile.id+"/picture?redirect=true&width=35&height=35",
						medium:	"http://graph.facebook.com/"+profile.id+"/picture?redirect=true&width=75&height=75",
						large:	"http://graph.facebook.com/"+profile.id+"/picture?redirect=true&width=140&height=140"
					};
